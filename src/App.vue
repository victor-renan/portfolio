  ...
  <main class="max-w-150 lg:max-w-7xl w-full flex flex-col lg:flex-row items-center lg:px-4">
    ...
    >
      <div class="p-4 pt-10 rounded-lg bg-stone-800 light:bg-stone-200 relative">
        ...
        <div class="flex flex-col items-center gap-3 text-center mb-6">
          ...
          <div>
            <h1 class="text-3xl font-bold text-blue-400 light:text-stone-600">Victor Renan</h1>
            <p class="text-blue-50 light:text-stone-950">Desenvolvedor Full Stack</p>
          </div>
        </div>
        ...
        <LinkContact
          title="Currículo"
          icon="bx bx-file"
          url="https://docs.google.com/document/d/1uuU55ll5_QLRupcbSjNVngVMlsdIM6PFoV923KAK-hU/edit?usp=sharing"
        />
      </div>
      <div
        class="px-4 py-10 rounded-lg bg-stone-800 light:bg-stone-200 flex justify-center flex-col"
      >
        <h1 class="text-center mb-4 text-lg font-bold text-blue-300 light:text-stone-600">
    ...
    <section class="lg:ml-106 w-full p-4 lg:pl-8 lg:py-8 animate-appear">
      <div class="flex flex-col">
        <h1
          class="text-center lg:text-left text-3xl font-bold text-blue-400 light:text-stone-600 mb-4"
        >
          Tecnologias
        </h1>
        <div class="flex flex-wrap gap-4">
          <TechItem name="PHP" description="A popular linguagem de desenvolvimento web">
            <template #icon>
              <svg class="fill-blue-400 light:fill-stone-700" viewBox="0 0 128 128">
                <path
          ...
          <TechItem name="Vue.js" description="Framework para criação de SPAs">
            <template #icon>
              <svg viewBox="0 0 128 128">
                ...
                <path
                  ...
                  class="fill-blue-400 light:fill-stone-700"
                ></path>
              </svg>
            </template>
          </TechItem>
      ...
      <div class="flex flex-col mt-8">
        ...
        <div class="flex flex-wrap gap-4">
          <LinkProject
            title="PixGenerator"
            description="Uma biblioteca sem dependências feita em PHP para geração de QR Codes Pix estáticos"
            url="https://packagist.org/packages/victor-renan/pixgenerator"
            imageUrl="https://opengraph.githubassets.com/0/victor-renan/pixgenerator"
          />
          <LinkProject
          ...
          />
          <LinkProject
            title="LAA Transparente"
            description="Sistema de gerenciamento de licenças ambientais com integrações de APIs do governo"
          ...
          <LinkProject
            ...
            url="https://github.com/victor-renan/prea"
          ...
          <LinkProject
            ...
            url="https://github.com/victor-renan/fileupload"
